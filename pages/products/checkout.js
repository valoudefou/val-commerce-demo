                ...
                <div className="mt-6 w-full">
                  ...
                  <div className="flex space-x-3 justify-start mt-7">
                    ...
                    <Link href='/products/confirmation'>
                      <button className="pointer-cursor flex items-center justify-center text-base font-medium bg-black text-white text-semibold py-3 px-6 rounded-full hover:bg-neutral-800">
