    ...
    <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8 mb-10 mt-10">
      ...
      <div className="mt-8 px-3">
        <ol className="flex items-center w-full">
          <li className="flex w-full items-center text-blue-600 dark:text-blue-500 after:content-[''] after:w-full after:h-1 after:border-b after:border-blue-600 after:border-4 after:inline-block dark:after:border-blue-800">
                ...
                <div className="mt-6 w-full">
                  ...
                  <div className="flex sm:flex-row flex-col sm:space-x-3 mt-8">
                    ...
                    <Link href='/products/confirmation'>
                      <button className="justify-center w-full flex text-base font-medium bg-black text-white text-extrabold py-3 px-14 rounded-full hover:bg-neutral-800">
                    ...
                    <span className="text-md p-1 flex justify-center">or</span>
                    <button onClick={() => [beginCheckout()]} className="justify-center w-full flex py-3 px-7 bg-white border hover:bg-gray-50 border-slate-600 text-slate-600 text-semibold text-sm rounded-full font-medium">
