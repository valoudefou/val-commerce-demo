...
const flagColorLine = useFsFlag("flagColorLine", "flex w-full items-center text-blue-600 dark:text-blue-500 after:content-[''] after:w-full after:h-1 after:border-b after:border-[red] after:border-4 after:inline-block dark:after:border-blue-800")
    ...
    <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8 mb-10 mt-10">
      ...
      <div className="mt-8 px-3">
        <ol className="flex items-center w-full">
          <li className={flagColorLine.getValue()}>
