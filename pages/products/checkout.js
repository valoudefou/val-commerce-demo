                ...
                <div className="mt-6 w-full">
                  ...
                  <div className="flex sm:flex-row flex-col sm:space-x-3 mt-8">
                    ...
                    <Link href='/products/confirmation'>
                      <button className="justify-center items-center w-full flex text-lg font-medium bg-black text-white text-extrabold py-4 px-14 rounded-full hover:bg-neutral-800">
