          ...
          {!paymentStep && (
            <div className="mt-8 px-3">
              <ol className="flex items-center w-full">
                <li className="flex w-full items-center text-blue-600 dark:text-blue-500 after:content-[''] after:w-full after:h-1 after:border-b-black after:border-4 after:inline-block dark:after:border-blue-800">
