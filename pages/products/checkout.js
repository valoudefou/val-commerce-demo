    ...
    <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8 mb-24 mt-24">
      ...
      <div className="mt-8 px-3">
        <ol class="flex items-center w-full">
          ...
          <li class="flex w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-100 after:border-4 after:inline-block dark:after:border-gray-700">
            <span class="text-blue-600 text-sm font-semibold flex items-center justify-center w-10 h-10 bg-blue-100 rounded-full lg:h-12 lg:w-12 dark:bg-blue-800 shrink-0">
              2
            </span>
          </li>
          <li class="flex w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-100 after:border-4 after:inline-block dark:after:border-gray-700">
      ...
      <div className="mt-10 flex flex-col xl:flex-row jusitfy-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
        <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
          <div className="border rounded flex flex-col justify-start items-start bg-gray-50 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
                ...
                <div className="w-full flex flex-col justify-start items-start space-y-8">
                  ...
                  <div className="flex justify-between items-start w-full">
                    <div className="flex flex-col flex-end">
                      <p className="text-sm dark:text-white leading-6 text-gray-700"><span className="dark:text-gray-400 text-gray-400">
                        Order: </span> {data.transactionId}</p>
                      <p className="text-sm dark:text-white leading-6 text-gray-700"><span className="dark:text-gray-400 text-gray-400">
                        Category: </span> {data.productCategory}</p>
                      <p className="text-sm dark:text-white leading-6 text-gray-700"><span className="dark:text-gray-400 text-gray-400">
                        Quantity: </span> {data.productQuantity}</p>
                    </div>
          ...
          <div className="border rounded px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
              ...
              <div className="w-full">
                ...
                <div className="mt-6 w-full">
                  <div className="mb-4">
                    ...
                    <div className="flex mt-5 align-start text-xs leading-4">
                    <label>
                ...
                <div className="mt-6 w-full">
                  ...
                  <div className="flex space-x-3 justify-start mt-7">
                    ...
                    <Link href='/products/confirmation'>
                      <button className="pointer-cursor flex items-center justify-center text-base font-medium bg-black text-white text-semibold py-3 rounded-full hover:bg-neutral-800 sm:px-8">
                    ...
                    <button onClick={() => [beginCheckout()]} className="flex items-center justify-center px-5 bg-white border hover:bg-gray-50 border-slate-600 text-slate-600 text-semibold text-sm rounded-full font-medium">
        ...
        <div className="bg-gray-50 w-full flex justify-between items-center md:items-start flex-col">
          <div className="lg:p-0 p-6 sm:p-6 md:p-6 lg:items-end md:items-end border rounded flex flex-col md:flex-row xl:flex-col-reverse xl:justify-end justify-start items-stretch h-full w-full md:space-x-6 lg:space-x-8 xl:space-x-0">
            <div className="flex flex-col lg:p-6 xl:p-8 md:p-0 ms:p-6 w-full bg-gray-50 space-y-6">
              <div className="flex border-gray-200 border-t pt-7">
            ...
            <div className="flex xl:pb-0 lg:pb-6 md:pb-6 justify-center md:flex-row flex-col items-stretch w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
              <div className="flex lg:mr-6 flex-col pt-6 xl:pl-8 xl:pt-6 w-full bg-gray-50 space-y-6">
                <h3 className="text-xl dark:text-white font-semibold leading-5 text-gray-800">
                  Shipping</h3>
                <div className="flex justify-between items-start w-full">
                  <div className="flex justify-center items-center space-x-4">
                    ...
                    <div className="flex flex-col justify-start items-center">
                      <p className="text-base leading-6 dark:text-white font-semibold text-gray-800">
                        DPD Delivery<br /><span className="text-base font-normal">
