            ...
            <div className="mx-auto mb-24 max-w-1xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="mx-auto items-center flex flex-col lg:flex-row">
                    ...
                    <div className="flex flex-col lg:p-20 md:p-10">
                        ...
                        <button onClick={() => [pushCart()]} className="mt-5 border border-black hover:border-gray-600 bg-white text-black hover:text-gray-600">
                            <Emotion />
                        </button>
                        {paymentFeature1Click.getValue() === 'true' &&
                            <button onClick={handleClick} className="flex items-center justify-center text-2xl font-medium mt-5 border border-transparent bg-black px-4 py-3 text-white shadow-sm hover:bg-neutral-800 sm:px-8 w-full"> 
