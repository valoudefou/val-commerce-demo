                ...
                <div className="mx-auto items-center flex flex-col lg:flex-row">
                    ...
                    <div className="flex flex-col lg:p-20 md:p-10">
                        ...
                        {paymentFeature1Click.getValue() === 'true' &&
                            <button onClick={handleClick} className="flex items-center justify-center text-xl tracking-tight font-medium mt-5 bg-black text-white text-bold py-3 px-7 rounded-full hover:bg-neutral-800 sm:px-8 w-full"> 
