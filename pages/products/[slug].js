            ...
            <div className="mx-auto mb-24 max-w-1xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="mx-auto items-center flex flex-col lg:flex-row">
                    ...
                    <div className="flex flex-col lg:p-20 md:p-10">
                        ...
                        <button onClick={() => [pushCart()]} className=".add-to-cart mt-5 bg-white border hover:bg-gray-50 border-slate-600 text-slate-600 text-semibold text-sm rounded-full font-medium w-full">
                            <Emotion />
                        </button>
