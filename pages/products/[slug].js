            ...
            <div className="mx-auto mb-24 max-w-1xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="mx-auto items-center flex flex-col lg:flex-row pt-10">
                    ...
                    <div className="mt-10 flex flex-col lg:pl-20 md:pl-0">
                        ...
                        <button onClick={() => [pushCart()]} className="mt-5 border border-black bg-white text-black">
                            <Emotion />
                        </button>
                        {paymentFeature1Click.getValue() === 'true' &&
                            <button onClick={handleClick} className="flex items-center justify-center text-2xl font-medium mt-5 border border-transparent bg-black px-4 py-3 text-white shadow-sm hover:bg-neutral-600 sm:px-8 w-full"> 
