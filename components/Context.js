...
export default function Context() {
    ...
    return (
        <>
        <div className="border flex flex-col border-gray-200 my-10 mx-10 py-7 px-9 fixed bottom-0 z-10 sm:w-2/3 md:w-2/3 lg:w-2/4 xl:w-2/6 w-auto bg-white rounded-2xl shadow-xl">
