    ...
    return (
        <>
            ...
            <footer className="center items-center mt-5 flex justify-center space-x-4 bg-[#E7E8EF] p-4 text-xs fixed inset-x-0 bottom-0 h-25 z-50 font-normal">
                <p>Powered by Next.js / Vercel / Tailwind / AB Tasty</p>
                    <span>|</span>
                <a href="https://github.com/valoudefou/commerce-demo" style={{color: flagBackgroundColor.getValue()}} className="p-[2px] bg-[#111827] rounded-[5px]">
                    GitHub
                </a>
            </footer>
        </>
