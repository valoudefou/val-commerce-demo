                    ...
                    <div className="grid grid-cols-1 gap-4">
                        ...
                        {cartContent && (
                                ...
                                <Link href='/products/checkout'>
                                    <button className="flex items-center justify-center py-3 px-6 bg-white border hover:bg-gray-50 border-gray-300 text-slate-600 text-semibold text-sm rounded-full font-medium">
