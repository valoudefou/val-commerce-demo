  ...
  const paymentFeature1Click = useFsFlag("paymentFeature1Click", "false")
    ...
    return (
        <div>
            ...
            <div className={scroll ? "fixed left-0 right-0 bg-white z-50 py-8 px-8 top-[0.5rem] border border-gray-200 rounded-lg mt-3 mr-[3vh] ml-[3vh] shadow-lg" : "absolute right-0 top-[3.5rem] bg-white z-50 py-8 px-8 border border-gray-200 rounded-2xl mt-3 mr-[3vh] ml-[3vh] shadow-lg"}>
                <div className="w-72">
                    <div className="grid grid-cols-1 gap-4">
                        ...
                        {cartContent && (
                                ...
                                <Link href='/products/confirmation'>
                                    <button className="w-[125px] flex items-center justify-center text-base font-medium bg-black text-white text-bold py-3 rounded-full hover:bg-neutral-800">
