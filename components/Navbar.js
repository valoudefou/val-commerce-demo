            ...
            <nav className="relative z-40 flex flex-wrap items-center justify-between px-2 py-2 bg-white border-b-[1px] border-gray-200">
                <div className="flex flex-auto lg:flex-wrap items-center justify-between">
                    <div className="relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
                        ...
                        <button
                            className="text-gray-900 cursor-pointer text-xl leading-none px-3 py-1 border border-solid border-transparent rounded bg-transparent block lg:hidden outline-none focus:outline-none" type="button">
                        </button>
                    </div>
                    ...
                    <div className="lg:flex items-center">
                        ...
                        <div onClick={() => setIsShown(!isShown)} className="flex justify-center px-7 py-3 md:block">
