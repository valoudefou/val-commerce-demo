...
export default function Navbar() {
    ...
    return (
        <>
            ...
            {searchOpen && (
                <div className="sm:hidden bg-white fixed w-full px-6 py-8 z-30 border-b-[1px] border-gray-200">
                    <input type="text" className="epoq_search_box w-full ui-autocomplete-input block p-5 font-light pl-10 text-gray-900 bg-gray-50 rounded border border-gray-200 focus:pl-10" placeholder='Search term ...' />
                    <div className="absolute top-14 left-9 items-center">
                        ...
                        <div className="navbar-menu relative z-40">
                            ...
                            <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
                                ...
                                <div>
                                    <ul>
                                        <li className="mb-1">
                                            <a className="block p-3 text-sm font-mormal text-gray-900 rounded" href="#">Documentation</a>
                                        </li>
                                        <li className="mb-1">
                                            <a className="block p-3 text-sm font-mormal text-gray-900 rounded" href="#">Contact</a>
                                        </li>
                                        <li className="mb-1">
                                            <a className="block p-3 text-sm font-mormal text-gray-900 rounded" href="#">About</a>
                                        </li>
                                    </ul>
                                </div>
                            </nav>   
                        ...
                        <div className="md:px-5 md:py-0 xl:py-0 px-3 lg:py-0 py-3 lg:flex items-center">
                            <ul className="hidden flex-col lg:flex lg:flex-row list-none">
                                <li className="nav-item">
                                    <a className="my-1 text-sm text-gray-900 hover:text-gray-700 font-mormal md:mx-4 md:my-0" href="#">
