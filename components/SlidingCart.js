            ...
            <div className="flex space-x-4 justify-start mt-3">
              {paymentFeature1Click.getValue() === 'true' &&
                <Link href='/products/confirmation'>
                  <button className="flex items-center text-base px-5 py-2 border border-transparent bg-black font-medium text-white shadow-sm hover:bg-neutral-800">
              ...
              <button onClick={() => [beginCheckout()]} className="items-center flex text-sm px-5 py-2 font-normal text-black border border-black  hover:border-gray-600 hover:text-gray-600">
