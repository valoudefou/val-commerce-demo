          ...
          <div className="flex items-center justify-between">
            ...
            {cartContent && (
              <span onClick={handleClick} className="text-gray-500 pl-5">
                <svg onClick={() => [handleRemoveItem()]} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5 cursor-pointer">
            ...
            <div className="flex space-x-3 justify-start mt-3">
              {paymentFeature1Click.getValue() === 'true' &&
                <Link href='/products/confirmation'>
                  <button className="flex items-center justify-center text-base font-medium bg-black text-white text-semibold py-2 rounded-full hover:bg-neutral-800 sm:px-8">
              ...
              <button onClick={() => [beginCheckout()]} className="flex items-center justify-center py-2 px-5 bg-white border hover:bg-gray-50 border-slate-600 text-slate-600 text-semibold text-sm rounded-full font-medium">
