        ...
        <div className="flex items-center justify-between">
          ...
          {cartContent && (
            <span onClick={handleClick} className="text-gray-500 pl-5">
              <svg onClick={() => [handleRemoveItem()]} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4">
          ...
          <div className="flex space-x-4 justify-start mt-3">
            {paymentFeature1Click.getValue() === 'true' &&
              <Link href='/products/confirmation'>
                <button className="flex items-center text-sm px-5 py-2 border border-transparent bg-black font-medium text-white shadow-sm hover:bg-neutral-600">
            ...
            <button className="items-center flex text-xs px-5 py-2 font-normal text-black border border-black">
